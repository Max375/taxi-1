            ...
            <React.Fragment>
                ...
                <div class={(this.props.isVisible) ? 'extra extra-open' : 'extra'}>
                    ...
                    <div class="extra-inputs clearfix">
                        <label><input defaultChecked={this.options.gender} name="gender" type="checkbox" onChange={this.handleInputChange}/>Девушка водитель <img /></label>
                        ...
                        <label><input defaultChecked={this.options.baggage} name="baggage" type="checkbox" onChange={this.handleInputChange} />Багаж <img /></label>
                        <label><input defaultChecked={this.options.dogPlace}  name="dogPlace" type="checkbox" onChange={this.handleInputChange} />Перевозка животного <img /></label>
